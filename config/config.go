...
const (
	flagAggregator        = "furyint.aggregator"
	flagDALayer           = "furyint.da_layer"
	flagDAConfig          = "furyint.da_config"
	flagSettlementLayer   = "furyint.settlement_layer"
	flagSettlementConfig  = "furyint.settlement_config"
	flagBlockTime         = "furyint.block_time"
	flagDABlockTime       = "furyint.da_block_time"
	flagBatchSyncInterval = "furyint.batch_sync_interval"
	flagDAStartHeight     = "furyint.da_start_height"
	flagNamespaceID       = "furyint.namespace_id"
	flagBlockBatchSize    = "furyint.block_batch_size"
)

var (
	// DefaultFuryintDir is the default directory for furyint
	DefaultFuryintDir = ".furyint"
)

// NodeConfig stores Furyint node configuration.
...
// AddFlags adds Furyint specific configuration options to cobra Command.
//
